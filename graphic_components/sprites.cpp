...
void sprite_component::render(SDL_Renderer* ren, const SDL_Rect* src_rect, const SDL_Rect* dst_rect) const {
...
void strech_bg::render(SDL_Renderer* ren) const {
	sprite_component::render(ren, &src_rect, &screen);
}